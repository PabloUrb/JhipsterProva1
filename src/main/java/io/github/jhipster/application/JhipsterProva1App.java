...
public class JhipsterProva1App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterProva1App.class);

    private final Environment env;

    public JhipsterProva1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JhipsterProva1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterProva1App.class);
